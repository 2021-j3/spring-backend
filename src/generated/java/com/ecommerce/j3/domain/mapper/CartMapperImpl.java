...
public class CartMapperImpl extends CartMapper {
    ...
    public Cart toEntity(CartApiRequest dto) {
        ...
        cart.firstName( dto.getFirstName() );
        cart.lastName( dto.getLastName() );
        cart.phoneNumber( dto.getPhoneNumber() );
        cart.email( dto.getEmail() );
    ...
    public CartApiResponse toApiResponse(Cart entity) {
        ...
        cartApiResponse.setFirstName( entity.getFirstName() );
        cartApiResponse.setLastName( entity.getLastName() );
        cartApiResponse.setPhoneNumber( entity.getPhoneNumber() );
        cartApiResponse.setEmail( entity.getEmail() );
